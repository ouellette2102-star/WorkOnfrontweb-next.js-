...
export function ProfileHeader({ user }: ProfileHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-workon-border bg-white/95 backdrop-blur">
      <div className="max-w-2xl mx-auto px-4 py-6">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex items-center gap-4 text-sm text-workon-gray mb-3">
          ...
          {user.bio && (
            <p className="text-sm text-workon-gray max-w-md">{user.bio}</p>
          )}
        </div>
      </div>
    </header>
