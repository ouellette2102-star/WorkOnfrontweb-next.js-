 ...
 * PR-27: CTA avec lien vers pricing
 */
  ...
  return (
    <Card className={`border-amber-500/20 bg-gradient-to-br from-amber-500/5 to-yellow-500/5 ${className}`}>
      <CardContent className="p-6">
        ...
        <Link href="/premium/pricing">
          <Button className="w-full bg-gradient-to-r from-amber-500 to-yellow-500 text-black font-semibold hover:from-amber-400 hover:to-yellow-400">
