...
const NOTIFICATION_TYPES: { type: NotificationType; label: string; detail: string }[] = [
  ...
  },
  {
    type: "NEW_OFFER",
    label: "Offres",
    detail: "Nouvelles propositions ou réponses importantes.",
  },
  {
    type: "MESSAGE",
    label: "Messages",
  ...
  },
  {
    type: "PAYMENT",
    label: "Paiements",
    detail: "Factures, reçus, revenus et versements.",
  },
  {
    type: "REVIEW",
    label: "Évaluations",
    detail: "Avis et réputation après mission.",
  },
  {
    type: "MARKETING",
    label: "Opportunités",
    detail: "Nouveautés, leads et annonces non critiques.",
  },
];
            ...
            <div className="flex items-start gap-3 min-[420px]:gap-4">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-2 max-w-xl text-sm leading-relaxed text-white/70 min-[420px]:mt-3">
                  ...
                  vérification, paiements, contrats, données et notifications.
                </p>
              </div>
            </div>
      ...
      <section className="mt-8 grid gap-4 lg:grid-cols-[1fr_0.9fr]">
        ...
        <div className="rounded-[28px] border border-workon-border bg-white p-5 shadow-sm">
          <SectionHeading
            ...
            text="Exporter les données, consulter les consentements et gérer la suppression de compte avec confirmation."
          />
