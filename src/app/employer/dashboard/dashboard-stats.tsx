  ...
  return (
    <>
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        {/* Missions actives */}
        <div className="rounded-3xl border border-workon-border bg-workon-bg/70 p-6 backdrop-blur">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-2xl font-bold text-workon-ink">Missions actives</h2>
        ...
        <div className="rounded-3xl border border-workon-border bg-workon-bg/70 p-6 backdrop-blur">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-2xl font-bold text-workon-ink">Offres en attente</h2>
          </div>
          {pendingOffers > 0 ? (
            <p className="text-workon-muted">
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-3">
        <div className="rounded-3xl border border-workon-border bg-workon-bg/70 p-6 backdrop-blur">
          <p className="text-sm text-workon-muted">Total missions cr&eacute;&eacute;es</p>
          <p className="mt-2 text-3xl font-bold text-workon-ink">
            {missions?.length ?? 0}
          </p>
        </div>
        <div className="rounded-3xl border border-workon-border bg-workon-bg/70 p-6 backdrop-blur">
          <p className="text-sm text-workon-muted">Missions compl&eacute;t&eacute;es</p>
          <p className="mt-2 text-3xl font-bold text-workon-ink">
            {completedMissions}
          </p>
        </div>
        <div className="rounded-3xl border border-workon-border bg-workon-bg/70 p-6 backdrop-blur">
          <p className="text-sm text-workon-muted">Offres en attente</p>
          <p className="mt-2 text-3xl font-bold text-workon-ink">
            {pendingOffers}
          </p>
        </div>
